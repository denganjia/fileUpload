...
CREATE TABLE `jobs` (
  ...
  `is_over` int(11) unsigned NOT NULL,
...
CREATE TABLE `students` (
  ...
  `s_Num` int(12) unsigned NOT NULL,
  `s_Name` varchar(255) NOT NULL,
  `s_Classname` varchar(255) NOT NULL,
...
CREATE TABLE `teachers` (
  ...
  `t_Account` varchar(16) CHARACTER SET utf8mb4 NOT NULL,
  `t_Name` varchar(255) NOT NULL,
...
-- Dump completed on 2020-05-08 12:13:18
